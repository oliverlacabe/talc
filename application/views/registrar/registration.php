			...
			<div class="panel-body">
				...
				<form class="form-horizontal" method="post" action="/registrar/add_student" role="form">
					<div class="form-group">
						<label class="control-label col-sm-3">Student ID <small class="required">(required)</small></label>
						<div class="col-sm-7">
					...
					<div class="form-group">
						<label class="control-label col-sm-3">Year & Section <small class="required">(required)</small></label>
						<div class="col-sm-7">
					...
					<div class="form-group">
						<label class="control-label col-sm-3">Guardian <small class="required">(required)</small></label>
						<div class="col-sm-7">
							<input class="form-control" type="text" name="guardian" value="" required placeholder="guardian">
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-3">GuardiansContact No. <small class="optional">(optional)</small></label>
						<div class="col-sm-7">
							<input class="form-control" type="text" name="contact2" value="" placeholder="guardian contact no.">
						</div>
					</div>
					<div class="form-group">
						<div class="col-md-10">
